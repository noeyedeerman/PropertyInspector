 ...
 */
public class Fragment_Note_Photo_Edit extends Fragment {
...
private ImageView mImageView_image;
    ...
    public Fragment_Note_Photo_Edit() {
    }


    public static Fragment_Note_Photo_Edit newInstance(Note note) {
        Fragment_Note_Photo_Edit fragment = new Fragment_Note_Photo_Edit();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImageView_image = (ImageView) mView.findViewById(R.id.imageView);
        ...
        mImageView_image = (ImageView) mView.findViewById(R.id.imageView_image);
