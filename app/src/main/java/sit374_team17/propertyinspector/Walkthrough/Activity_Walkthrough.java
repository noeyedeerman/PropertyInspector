...
public class Activity_Walkthrough extends AppCompatActivity implements Listener_Walkthrough{
    ...
    @Override
    public void goTo_8_finish() {
        Fragment_Walkthrough_8_Finish fragment = Fragment_Walkthrough_8_Finish.newInstance();
        replaceFragment(fragment, "fragment_8_finish");
    }
    ...
    private void replaceFragment(Fragment fragment, String tag) {
        try {
            ...
            if (tag != "fragment_1_start"){
                ...
                if (tag == "fragment_2_loan" || tag == "fragment_3_lawyer" || tag == "fragment_4_electrical" || tag == "fragment_5_gas" || tag == "fragment_6_internet" || tag == "fragment_7_moval" || tag == "fragment_8_finish") {
